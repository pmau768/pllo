...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: dog.images?.[0] || 'https://images.unsplash.com/photo-1543466835-00a7907e9de1?auto=format&fit=crop&w=800&q=80',
          width: 800,
          height: 600,
          alt: dog.name,
        },
    ...
    twitter: {
      ...
      title: `Meet ${dog.name} - ${dog.breed} | Trek Snout`,
      description: dog.description.substring(0, 160),
      images: [dog.images?.[0] || 'https://images.unsplash.com/photo-1543466835-00a7907e9de1?auto=format&fit=crop&w=800&q=80'],
    },
  };
}
    ...
    <div className="section-container">
      ...
      <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-start mb-12 print-section">
        <div className="relative">
          <Image
            src={dog.images?.[0] || 'https://images.unsplash.com/photo-1543466835-00a7907e9de1?auto=format&fit=crop&w=800&q=80'}
            alt={dog.name}
            width={600}
            height={400}
          ...
          <div className="absolute top-4 right-4 no-print">
            <SocialShareButtons 
              ...
              media={dog.images?.[0] || 'https://images.unsplash.com/photo-1543466835-00a7907e9de1?auto=format&fit=crop&w=800&q=80'}
